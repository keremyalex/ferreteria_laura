...
class compra extends Model
{
    ...
    static public function UpdateCompra($id, array $data)
    {
        ...
        $compra->monto_total = $data['monto_total'] ?? $compra->monto_total;
